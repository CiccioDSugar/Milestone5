...
/*   Updated: 2025/09/16 14:47:01 by fzuccaro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Trying to increment the grade of " << this->name << " from " << this->grade << " to " << this->grade - n << std::endl << std::endl;
	if ((this->grade - n) < 1)
		throw Bureaucrat::GradeTooHighException();
	this->grade-= n;
...
/*----------------------------Form Membre Functions----------------------------*/

void                Bureaucrat::executeForm(const AForm &form) const
{
	try 
	{
        form.execute(*this);  // Tenta di eseguire il form
