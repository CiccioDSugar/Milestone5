...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/22 18:11:48 by fzuccaro          #+#    #+#             */
/*   Updated: 2025/09/26 19:10:54 by fzuccaro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int ac, char **av)
{
    if (ac == 2)
    {
       ScalarConverter::convert(av[1]);
        ...
        std::cout << std::endl << "Program individuated an INVALIDINPUT error" << std::endl << std::endl;
}
